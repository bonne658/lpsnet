...
def get_lspnet_s(num_classes=2, deploy=False):
    depth = (1, 3, 3, 10, 10)
    width = (8, 24, 48, 96, 96)
    resolution = (3 / 4, 1 / 4, 0)
    net = get_lpsnet(depth, width, resolution, num_classes, deploy=deploy)
    return net


def get_lspnet_m(num_classes=2, deploy=False):
    depth = (1, 3, 3, 10, 10)
    width = (8, 24, 48, 96, 96)
    resolution = (1, 1 / 4, 0)
    net = get_lpsnet(depth, width, resolution, num_classes, deploy=deploy)
...
def get_lspnet_l(num_classes=2, deploy=False):
    depth = (1, 3, 3, 10, 10)
